...
<div class="ui-layout-north">欢迎[<shiro:principal/>]学习Shiro综合案例，<a href="${pageContext.request.contextPath}/logout">退出</a><a style="margin-left: 20px" href="http://127.0.0.1:8083/">应用1</a></div>
